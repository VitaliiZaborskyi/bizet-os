(()=> {
  const VERSION='POINT-B-2026-09-24';
  const PRICES={
    ...
    ASSEMBLY_M2:160,PACKING_M2:10,INSTALL_M2:320,DELIVERY_TRIP:3000,RPR_HOUR:500
  };
  ...
  function buildBOM(modules,details){
    ...
    add('Работы','Сборка',panelArea,'м²',PRICES.ASSEMBLY_M2);
    add('Работы','Упаковка',panelArea,'м²',PRICES.PACKING_M2);
    add('Работы','Установка',panelArea,'м²',PRICES.INSTALL_M2);
